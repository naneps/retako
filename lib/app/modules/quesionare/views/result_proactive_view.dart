...
class ResultProactiveCSC extends StatefulWidget {
  const ResultProactiveCSC({super.key});

  @override
  State<ResultProactiveCSC> createState() => _ResultProactiveCSCState();
}

class _ResultProactiveCSCState extends State<ResultProactiveCSC> {
